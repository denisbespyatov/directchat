...
class Conversation extends ActiveRecord
{
    ...
    /*public function getActiveCoversations2($id)
    {
        $res = 1;

        $query = $this->find()->where(['or', ['sender_id' => $id], ['receiver_id' => $id]]);

        return $query;
    }

    public static function getActiveCoversations($id)
    {

        $res = null;
        $res = ActiveRecord::find()
//            ->andWhere(['sender_id' => $id,'is_deleted_by_sender' => false])
            ->where('or', ['sender_id' => $id], ['receiver_id' => $id])
            ->andWhere(['is_deleted_by_receiver' => false,'is_deleted_by_sender' => false])
        ;
        return $res;
    }*/
